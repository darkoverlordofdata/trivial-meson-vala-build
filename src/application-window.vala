namespace Example {
    ...
    [GtkTemplate (ui = "/com/github/darkoverlordofdata/trivial/window.ui")]
    public class ApplicationWindow : Gtk.ApplicationWindow {
        ...
        public ApplicationWindow (Gtk.Application application) {
            ...
            settings = new GLib.Settings ("com.github.darkoverlordofdata.trivial");
            ...
            var builder = new Gtk.Builder.from_resource ("/com/github/darkoverlordofdata/trivial/gears-menu.ui");
